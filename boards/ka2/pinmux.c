...
{
    //HPM_BIOC->PAD[IOC_PAD_PZ11].FUNC_CTL = IOC_PZ11_FUNC_CTL_I2C0_SCL | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;
    //HPM_BIOC->PAD[IOC_PAD_PZ11].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1);

    //HPM_BIOC->PAD[IOC_PAD_PZ10].FUNC_CTL = IOC_PZ10_FUNC_CTL_I2C0_SDA | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;
    //HPM_BIOC->PAD[IOC_PAD_PZ10].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1);
...
void init_trgm_gptmr5_cap2_invert_pins(void)
{
    ...
    trgm_output_config(HPM_TRGM2, HPM_TRGM2_OUTPUT_SRC_GPTMR5_IN2, &trgm2_io_config0);
}

void init_hb_led_pin(void)
{
    HPM_IOC->PAD[IOC_PAD_PE28].FUNC_CTL = IOC_PE28_FUNC_CTL_GPIO_E_28;
}
